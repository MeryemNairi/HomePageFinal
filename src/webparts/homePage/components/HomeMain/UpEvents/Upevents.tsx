...
const UpEvents: React.FC<ILatestNewsProps> = (props: ILatestNewsProps) => {
    ...
    const [, setEvents] = React.useState<EventsItem[]>([]); // State to hold the fetched events
    const [, ] = React.useState(0); // State to track the current index
                        ...
                        <div  ref={cardsContainerRef}>
                            <div className={styles.cards_container2} >
                                ...
                                {newsData.map((item, index) => (
                                    <div className={styles.card} key={index} style={{ width: '600px', height: '600px' }}>
